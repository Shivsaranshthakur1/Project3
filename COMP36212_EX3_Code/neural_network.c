...
// ******** Intermediate gradients (internal to neural network.c - avoids re-evaluation during
// backward pass) ********
...
void inline evaluate_dh_dW_Lh_Lprev(unsigned int n_h, unsigned int n_prev, n_ReLu neur[n_prev],
...
void inline sparse_multiply_dL_dh_by_dh_dW_LH_LH_prev(unsigned int rows1, unsigned int cols1,
                                                      double mat1[][cols1],  // dl_dh
...
double drand(double min, double max) {  //
    ...
    random_double =
        (float)rand() / RAND_MAX;  // note rand() only generates a 32-bit random number (no use
...
void evaluate_forward_pass(uint8_t** dataset, int n) {
    // Forward pass
    // For each layer of the network, j is used to index neurons in current layer, and i to index
    // neurons in preceding layer
...
void evaluate_backward_pass(uint8_t label, unsigned int input_class_index) {
    ...
    evaluate_dh_dW_Lh_Lprev(N_NEURONS_LO, N_NEURONS_L3, n_L3, N_NEURONS_LO * N_NEURONS_L3,
                            dhO_dW_L3_LO);  // dhO_dW_L3_LO
    evaluate_dh_dW_Lh_Lprev(N_NEURONS_L3, N_NEURONS_L2, n_L2, N_NEURONS_L3 * N_NEURONS_L2,
                            dh3_dW_L2_L3);  // dh3_dW_L2_L3
    evaluate_dh_dW_Lh_Lprev(N_NEURONS_L2, N_NEURONS_L1, n_L1, N_NEURONS_L2 * N_NEURONS_L1,
    ...
    double_matrix_multiply(1, N_NEURONS_LO, dL_dP, N_NEURONS_LO, N_NEURONS_LO, dP_dhO, 1,
                           N_NEURONS_LO, dL_dhO);
    double_matrix_multiply(1, N_NEURONS_LO, dL_dhO, N_NEURONS_LO, N_NEURONS_L3 * N_NEURONS_LO,
                           dhO_dW_L3_LO, 1, N_NEURONS_L3 * N_NEURONS_LO, dL_dW_L3_LO);

    // dL_dW_L2_L3 = (dL_dhO * dhO_dh3) * dh3_dW_L2_L3
    double_matrix_multiply(1, N_NEURONS_LO, dL_dhO, N_NEURONS_LO, N_NEURONS_L3, dhO_dh3, 1,
                           N_NEURONS_L3, dL_dh3);
    double_matrix_multiply(1, N_NEURONS_L3, dL_dh3, N_NEURONS_L3, N_NEURONS_L2 * N_NEURONS_L3,
                           dh3_dW_L2_L3, 1, N_NEURONS_L2 * N_NEURONS_L3, dL_dW_L2_L3);

    // dL_dW_L1_L2 = (dL_h3 * dh3_dh2) * dh2_dW_L1_L2
    double_matrix_multiply(1, N_NEURONS_L3, dL_dh3, N_NEURONS_L3, N_NEURONS_L2, dh3_dh2, 1,
                           N_NEURONS_L2, dL_dh2);
    double_matrix_multiply(1, N_NEURONS_L2, dL_dh2, N_NEURONS_L2, N_NEURONS_L1 * N_NEURONS_L2,
                           dh2_dW_L1_L2, 1, N_NEURONS_L1 * N_NEURONS_L2, dL_dW_L1_L2);

    // dL_dW_LI_L1 = (dL_dh2 * dh2_dh1) * dh1_dW_LI_L1
    double_matrix_multiply(1, N_NEURONS_L2, dL_dh2, N_NEURONS_L2, N_NEURONS_L1, dh2_dh1, 1,
                           N_NEURONS_L1, dL_dh1);
    double_matrix_multiply(1, N_NEURONS_L1, dL_dh1, N_NEURONS_L1, N_NEURONS_LI * N_NEURONS_L1,
...
void evaluate_backward_pass_sparse(uint8_t label, unsigned int input_class_index) {
    ...
    evaluate_dh_dW_Lh_Lprev_sparse(N_NEURONS_LO, N_NEURONS_L3, n_L3, N_NEURONS_LO * N_NEURONS_L3,
                                   dhO_dW_L3_LO);  // dhO_dW_L3_LO
    evaluate_dh_dW_Lh_Lprev_sparse(N_NEURONS_L3, N_NEURONS_L2, n_L2, N_NEURONS_L3 * N_NEURONS_L2,
                                   dh3_dW_L2_L3);  // dh3_dW_L2_L3
    evaluate_dh_dW_Lh_Lprev_sparse(N_NEURONS_L2, N_NEURONS_L1, n_L1, N_NEURONS_L2 * N_NEURONS_L1,
                                   dh2_dW_L1_L2);     // dh2_dW_L1_L2
    ...
    double_matrix_multiply(1, N_NEURONS_LO, dL_dP, N_NEURONS_LO, N_NEURONS_LO, dP_dhO, 1,
                           N_NEURONS_LO, dL_dhO);
    sparse_multiply_dL_dh_by_dh_dW_LH_LH_prev(1, N_NEURONS_LO, dL_dhO, N_NEURONS_LO,
    ...
    double_matrix_multiply(1, N_NEURONS_LO, dL_dhO, N_NEURONS_LO, N_NEURONS_L3, dhO_dh3, 1,
                           N_NEURONS_L3, dL_dh3);
    sparse_multiply_dL_dh_by_dh_dW_LH_LH_prev(1, N_NEURONS_L3, dL_dh3, N_NEURONS_L3,
    ...
    double_matrix_multiply(1, N_NEURONS_L3, dL_dh3, N_NEURONS_L3, N_NEURONS_L2, dh3_dh2, 1,
                           N_NEURONS_L2, dL_dh2);
    sparse_multiply_dL_dh_by_dh_dW_LH_LH_prev(1, N_NEURONS_L2, dL_dh2, N_NEURONS_L2,
    ...
    double_matrix_multiply(1, N_NEURONS_L2, dL_dh2, N_NEURONS_L2, N_NEURONS_L1, dh2_dh1, 1,
                           N_NEURONS_L1, dL_dh1);
    sparse_multiply_dL_dh_by_dh_dW_LH_LH_prev(1, N_NEURONS_L1, dL_dh1, N_NEURONS_L1,
